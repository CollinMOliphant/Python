...
try:
    while current_day <= days_running: 
        ...
        if current_day == 2 or current_day == 4 or current_day == 6 or current_day == 8 or current_day == 10 or current_day == 12 or current_day == 14:
            print ""
            print "Day" + " " + str(current_day)
            print "Turned off"
            print ""
         ...
         #turn fertilizer pump on day 3, 7, 11
        #if current_day == 3 or current_day == 7 or current_day == 11:
           # fertCounter = fertONtime
          #  print ""
          #  print "Day " + str(current_day)
          #  print "Fert for " +  str(fertONtime) + " Minutes"
        ...
        #watering on day 3,5,7,9,11,13
        if  current_day == 3 or current_day == 5 or current_day == 7  or current_day == 9 or current_day == 11 or current_day == 13:    
            waterCounter = waterONtime
            print ""
            print "Day" + " " + str(current_day)
